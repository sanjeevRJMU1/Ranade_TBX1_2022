## 12/06
## because of the renamed cluster idents on 08/30, I realized now that I need to re-call peaks and re-run DAR


# Break up each cluster into WT and KO, then add this as a new cellcoldata column called Clusters8
...
# rename to clusters8 and keep 7 for now
mesoderm_subset$Clusters8 <- as.character(condition.vec)
# spot check
...
mesoderm_subset <- addGroupCoverages(ArchRProj = mesoderm_subset, groupBy = "Clusters8", minCells = 40, maxCells = 1500, force = T)
#2021-12-06 10:19:48 : Finished Creation of Coverage Files!, 51.424 mins elapsed.
...
# Neural_Crest_05_K                                 Neural_Crest_05_K   2639       2610           2 1110 1500   150000
# Neural_Crest_05_W                                 Neural_Crest_05_W   2948       2926           2 1426 1500   150000
# Neural_Crest_15_K                                 Neural_Crest_15_K   1493       1493           3  299  678   150000
# Neural_Crest_15_W                                 Neural_Crest_15_W   4305       3000           2 1500 1500   150000
# Neural_Crest_25_K                                 Neural_Crest_25_K    480        480           2  178  302   150000
# Neural_Crest_25_W                                 Neural_Crest_25_W    398        398           2   76  322   150000
...
#2021-12-06 12:34:32 : Finished Creating Union Peak Set (475450)!, 134.716 mins elapsed.
...
## RNA integration not included here apparently. it's because I don't add the matrix to the arrow files!!
...
########
# save and make a note about different peak set!!
