...
markerGenes <- c("Twist1","Postn","Pecam1","Cdh5","Sox2","Hes3","Epcam","Cldn7","Meox1","Tbx1","Dlx5","Dlx2","Hba-x","Tnnt2","Actc1","Tbx18","Wt1","Mab21l2","	
Upk3b")
length(markerGenes)
...
marker_labels = rowAnnotation(foo = anno_mark(
  ...
  annotation_legend_param = list(direction = "vertical",
                                 ...
                                 padding = unit(10, "mm")))
my_order <-c("EndMT","Endothelium","Ectoderm","Endoderm","SHF_Progenitor","Paraxial_Mesoderm","Neural_Crest","Blood","Cardiomyocyte","Epicardium","LPM")
stats.plot<-mark_stats.plot[,my_order]
...
draw(Heatmap(matrix = mark_stats.plot,
             ...
             show_row_names = F,
             show_column_names = T,
             col=colorRamp2(c(-1, 0, 1.5), c("grey", "white", "red")),
