...
Tbx1_trim_E115 <- Tbx1_trim
table(Tbx1_trim_E115@active.ident,Tbx1_trim_E115$gem.group)



#0
clust0 <- SubsetData(Tbx1_trim_E115, ident.use = 0)
...
#1
clust1 <- SubsetData(Tbx1_trim_E115, ident.use = 1)
...
#2
clust2 <- SubsetData(Tbx1_trim_E115, ident.use = 2)
...
#3
clust3 <- SubsetData(Tbx1_trim_E115, ident.use = 3)
...
#4
clust4 <- SubsetData(Tbx1_trim_E115, ident.use = 4)
...
#5
clust5 <- SubsetData(Tbx1_trim_E115, ident.use = 5)
...
#6
clust6 <- SubsetData(Tbx1_trim_E115, ident.use = 6)
...
#7
clust7 <- SubsetData(Tbx1_trim_E115, ident.use = 7)
...
#8
clust8 <- SubsetData(Tbx1_trim_E115, ident.use = 8)
...
#9
clust9 <- SubsetData(Tbx1_trim_E115, ident.use = 9)
...
#10
clust10 <- SubsetData(Tbx1_trim_E115, ident.use = 10)
...
#11
clust11 <- SubsetData(Tbx1_trim_E115, ident.use = 11)
...
#12
clust12 <- SubsetData(Tbx1_trim_E115, ident.use = 12)
...
#13
clust13 <- SubsetData(Tbx1_trim_E115, ident.use = 13)
...
#14
clust14 <- SubsetData(Tbx1_trim_E115, ident.use = 14)
...
#15
clust15 <- SubsetData(Tbx1_trim_E115, ident.use = 15)
...
#16
clust16 <- SubsetData(Tbx1_trim_E115, ident.use = 16)
...
#17
clust17 <- SubsetData(Tbx1_trim_E115, ident.use = 17)
...
#18
clust18 <- SubsetData(Tbx1_trim_E115, ident.use = 18)
...
#19
clust19 <- SubsetData(Tbx1_trim_E115, ident.use = 19)
...
#20
clust20 <- SubsetData(Tbx1_trim_E115, ident.use = 20)
