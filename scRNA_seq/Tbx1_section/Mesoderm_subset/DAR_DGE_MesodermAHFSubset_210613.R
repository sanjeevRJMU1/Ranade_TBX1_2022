...
DimPlot(Tbx1_mesoderm_cnc, reduction = "umap", label = F, pt.size = 0.1, group.by = "gem.group") 

#### after running homer annotate on motif1 (Tbox motif)
AHF_motif1 <- read.csv(file="/Users/sranade/scATAC-seq/Mesoderm_subset3_210517/Exports/DAR_exports/AHF/homer_annotate/AHF_motif1_outputfile.txt", sep = '\t')
# filter rows without a motif
AHF_motif1_filtered <- AHF_motif1[AHF_motif1$X1.GTGWTGAMAGAT.BestGuess.Tbx20.T.box..Heart.Tbx20.ChIP.Seq.GSE29636..Homer.0.856..Distance.From.Peak.sequence.strand.conservation.!="",]
write.csv(AHF_motif1_filtered, file = "/Users/sranade/scRNA-seq/2020_Tbx1/all_aggr_210429/DGE/annotated/E925/DAR_DGE_AHF_E95/AHF_motif1_filtered.csv", row.names = F)
...
AHF_DGE_list <- read.csv("/Users/sranade/scRNA-seq/2020_Tbx1/all_aggr_210429/DGE/annotated/E925/DAR_DGE_AHF_E95/AHF_E95_DGE_list.csv", header = F)
...
## write
write.csv(AHF_Tbx1_DAR_DGE_match,file = "/Users/sranade/scRNA-seq/2020_Tbx1/all_aggr_210429/DGE/annotated/E925/AHF_DARDGE_unfiltered.csv")
...
write.csv(AHF_Tbx1_DAR_DGE_match_sorted_trim, file = "/Users/sranade/scRNA-seq/2020_Tbx1/all_aggr_210429/DGE/annotated/E925/AHF_TF_sorted.csv", quote = F, row.names = F, sep = '\t')
