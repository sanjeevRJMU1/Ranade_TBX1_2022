...
AHF_wt <- OldWhichCells(Tbx1_mesoderm_cnc_e105, ident.keep = c("Anterior_Second_Heart_Field"),subset.name = "gem.group", accept.value = "WT_E105")
Cardiopharyngeal_Mesenchyme_wt <- OldWhichCells(Tbx1_mesoderm_cnc_e105, ident.keep = c("Cardiopharyngeal_Mesenchyme"),subset.name = "gem.group", accept.value = "WT_E105")
Cardiopharyngeal_Mesoderm_wt <- OldWhichCells(Tbx1_mesoderm_cnc_e105, ident.keep = c("Cardiopharyngeal_Mesoderm"),subset.name = "gem.group", accept.value = "WT_E105")
Cranial_Mesenchyme_wt <- OldWhichCells(Tbx1_mesoderm_cnc_e105, ident.keep = c("Cranial_Mesenchyme"),subset.name = "gem.group", accept.value = "WT_E105")
Paraxial_Mesoderm_wt <- OldWhichCells(Tbx1_mesoderm_cnc_e105, ident.keep = c("Paraxial_Mesoderm"),subset.name = "gem.group", accept.value = "WT_E105")

AHF_ko <- OldWhichCells(Tbx1_mesoderm_cnc_e105, ident.keep = c("Anterior_Second_Heart_Field"),subset.name = "gem.group", accept.value = "KO_E105")
Cardiopharyngeal_Mesenchyme_ko <- OldWhichCells(Tbx1_mesoderm_cnc_e105, ident.keep = c("Cardiopharyngeal_Mesenchyme"),subset.name = "gem.group", accept.value = "KO_E105")
Cardiopharyngeal_Mesoderm_ko <- OldWhichCells(Tbx1_mesoderm_cnc_e105, ident.keep = c("Cardiopharyngeal_Mesoderm"),subset.name = "gem.group", accept.value = "KO_E105")
Cranial_Mesenchyme_ko <- OldWhichCells(Tbx1_mesoderm_cnc_e105, ident.keep = c("Cranial_Mesenchyme"),subset.name = "gem.group", accept.value = "KO_E105")
Paraxial_Mesoderm_ko <- OldWhichCells(Tbx1_mesoderm_cnc_e105, ident.keep = c("Paraxial_Mesoderm"),subset.name = "gem.group", accept.value = "KO_E105")

Idents(object = Tbx1_mesoderm_cnc_e105, cells= AHF_wt) <- "wt_AHF"
Idents(object = Tbx1_mesoderm_cnc_e105, cells= Cardiopharyngeal_Mesenchyme_wt) <- "wt_Cardiopharyngeal_Mesenchyme"
Idents(object = Tbx1_mesoderm_cnc_e105, cells= Cardiopharyngeal_Mesoderm_wt) <- "wt_Cardiopharyngeal_Mesoderm"
Idents(object = Tbx1_mesoderm_cnc_e105, cells= Cranial_Mesenchyme_wt) <- "wt_Cranial_Mesenchyme"
Idents(object = Tbx1_mesoderm_cnc_e105, cells= Paraxial_Mesoderm_wt) <- "wt_Paraxial_Mesoderm"

Idents(object = Tbx1_mesoderm_cnc_e105, cells= AHF_ko) <- "ko_AHF"
Idents(object = Tbx1_mesoderm_cnc_e105, cells= Cardiopharyngeal_Mesenchyme_ko) <- "ko_Cardiopharyngeal_Mesenchyme"
Idents(object = Tbx1_mesoderm_cnc_e105, cells= Cardiopharyngeal_Mesoderm_ko) <- "ko_Cardiopharyngeal_Mesoderm"
Idents(object = Tbx1_mesoderm_cnc_e105, cells= Cranial_Mesenchyme_ko) <- "ko_Cranial_Mesenchyme"
Idents(object = Tbx1_mesoderm_cnc_e105, cells= Paraxial_Mesoderm_ko) <- "ko_Paraxial_Mesoderm"
...
# subset for cellchat
wt_cellchat <- SubsetData(Tbx1_mesoderm_cnc_e105, ident.use = c("wt_Craniofacial_NeuralCrest","wt_Cardiac_NeuralCrest",
...
my_levels_wt <- c("wt_Migratory_NeuralCrest","wt_Craniofacial_NeuralCrest",
                  ...
                  "wt_AHF","wt_Cardiopharyngeal_Mesenchyme","wt_Cardiopharyngeal_Mesoderm",
                  "wt_Cranial_Mesenchyme","wt_Paraxial_Mesoderm")
...
# subset for cellchat
ko_cellchat <- SubsetData(Tbx1_mesoderm_cnc_e105, ident.use = c("ko_Craniofacial_NeuralCrest","ko_Cardiac_NeuralCrest",
                                                                "ko_Migratory_NeuralCrest","ko_PA3_Cardiac_NeuralCrest",
                                                                "ko_AHF","ko_Cardiopharyngeal_Mesenchyme",
                                                                "ko_Cardiopharyngeal_Mesoderm","ko_Cranial_Mesenchyme",
                                                                "ko_Paraxial_Mesoderm"))
...
my_levels_ko <- c("ko_Migratory_NeuralCrest","ko_Craniofacial_NeuralCrest",
                  ...
                  "ko_AHF","ko_Cardiopharyngeal_Mesenchyme","ko_Cardiopharyngeal_Mesoderm",
                  "ko_Cranial_Mesenchyme","ko_Paraxial_Mesoderm")
...
# 405                            172                            312                            527 
# ko_AHF ko_Cardiopharyngeal_Mesenchyme   ko_Cardiopharyngeal_Mesoderm          ko_Cranial_Mesenchyme 
# 344                           2425                           1560                           1172 
# ko_Paraxial_Mesoderm 
# 1546
