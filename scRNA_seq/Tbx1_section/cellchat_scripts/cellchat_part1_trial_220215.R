...
Idents(object = Tbx1_mesoderm_cnc_e115, cells= AHF_ko) <- "ko_AHF"
...
# subset for cellchat
ko_cellchat <- SubsetData(Tbx1_mesoderm_cnc_e115, ident.use = c("ko_Craniofacial_NeuralCrest","ko_Cardiac_NeuralCrest",
...
#### rename idents
wt_cellchat <- RenameIdents(wt_cellchat, "wt_Migratory_NeuralCrest"="Migratory_NeuralCrest",
                            "wt_Craniofacial_NeuralCrest"="Craniofacial_NeuralCrest",
                            "wt_PA3_Cardiac_NeuralCrest"="PA3_Cardiac_NeuralCrest",
                            "wt_Cardiac_NeuralCrest"="Cardiac_NeuralCrest",
                            "wt_AHF"="AHF",
                            "wt_Cardiopharyngeal_Mesenchyme"="Cardiopharyngeal_Mesenchyme",
                            "wt_Cardiopharyngeal_Mesoderm"="Cardiopharyngeal_Mesoderm",
                            "wt_Cranial_Mesenchyme"="Cranial_Mesenchyme",
                            "wt_Paraxial_Mesoderm"="Paraxial_Mesoderm")

table(wt_cellchat@active.ident)
# Migratory_NeuralCrest    Craniofacial_NeuralCrest     PA3_Cardiac_NeuralCrest         Cardiac_NeuralCrest 
# 176                        1799                         559                        1158 
# AHF Cardiopharyngeal_Mesenchyme   Cardiopharyngeal_Mesoderm          Cranial_Mesenchyme 
# 542                        1007                         441                         691 
# Paraxial_Mesoderm 
# 455


ko_cellchat <- RenameIdents(ko_cellchat, "ko_Migratory_NeuralCrest"="Migratory_NeuralCrest",
                            "ko_Craniofacial_NeuralCrest"="Craniofacial_NeuralCrest",
                            "ko_PA3_Cardiac_NeuralCrest"="PA3_Cardiac_NeuralCrest",
                            "ko_Cardiac_NeuralCrest"="Cardiac_NeuralCrest",
                            "ko_AHF"="AHF",
                            "ko_Cardiopharyngeal_Mesenchyme"="Cardiopharyngeal_Mesenchyme",
                            "ko_Cardiopharyngeal_Mesoderm"="Cardiopharyngeal_Mesoderm",
                            "ko_Cranial_Mesenchyme"="Cranial_Mesenchyme",
                            "ko_Paraxial_Mesoderm"="Paraxial_Mesoderm")
