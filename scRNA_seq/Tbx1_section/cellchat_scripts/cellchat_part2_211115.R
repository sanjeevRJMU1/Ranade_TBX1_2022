...
df.net_wt <- subsetCommunication(cellchat_wt, sources.use = c("wt_Paraxial_Mesoderm","wt_Cranial_Mesenchyme","wt_Cardiopharyngeal_Mesoderm","wt_Cardiopharyngeal_Mesenchyme","wt_AHF"), targets.use = c("wt_PA3_Cardiac_NeuralCrest","wt_Migratory_NeuralCrest","wt_Cardiac_NeuralCrest","wt_Craniofacial_NeuralCrest"))
write.csv(df.net_wt, file = "/Users/sranade/scRNA-seq/2020_Tbx1/all_aggr_210429/cellchat_results/df_net_wt_220215.csv")
...
write.csv(pathways_wt, file = "/Users/sranade/scRNA-seq/2020_Tbx1/all_aggr_210429/cellchat_results/pathways_wt_220215.csv")
...
### if you want, subset out dataframes of the communication networks, esp useful if you want to look a specific subset!!!
df.net_ko <- subsetCommunication(cellchat_ko, sources.use = c("ko_Paraxial_Mesoderm","ko_Cranial_Mesenchyme","ko_Cardiopharyngeal_Mesoderm","ko_Cardiopharyngeal_Mesenchyme","ko_AHF"), targets.use = c("ko_PA3_Cardiac_NeuralCrest","ko_Migratory_NeuralCrest","ko_Cardiac_NeuralCrest","ko_Craniofacial_NeuralCrest"))
write.csv(df.net_ko, file = "/Users/sranade/scRNA-seq/2020_Tbx1/all_aggr_210429/cellchat_results/df_net_ko_220215.csv")
...
pathways_ko <- as.vector(cellchat_ko@netP$pathways)
write.csv(pathways_ko, file = "/Users/sranade/scRNA-seq/2020_Tbx1/all_aggr_210429/cellchat_results/pathways_ko_220215.csv")
...
netVisual_bubble(cellchat_ko, sources.use = c(5), targets.use = c(2), remove.isolate = FALSE)
