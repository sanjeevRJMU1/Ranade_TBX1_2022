...
cellchat_wt@netP$pathways # 51 total pathways
pathways <- as.vector(cellchat_wt@netP$pathways)
write.csv(pathways, file = "/Users/sranade/scRNA-seq/2020_Tbx1/all_aggr_210429/cellchat_results/unannotated/pathways_unannotated_E115_wt.csv")

levels(cellchat_wt@idents) # show factor levels of the cell labels

vertex.receiver = c(1,2,3,4) # a numeric vector, based on the order of idents
pathways.show <- c("EPHA") # go thru this fully!
...
pathways.show <- c("SEMA3") # go thru this fully!
...
write.csv(pathways, file = "/Users/sranade/scRNA-seq/2020_Tbx1/all_aggr_210429/cellchat_results/unannotated/pathways_unannotated_E115_ko.csv")
